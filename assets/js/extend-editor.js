...
/******/ 	return __webpack_require__(__webpack_require__.s = "./_dev/guten-block/index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./_dev/guten-block/i18n.js":
/*!**********************************!*\
  !*** ./_dev/guten-block/i18n.js ***!
  \**********************************/
...
wp.i18n.setLocaleData({ '': {} }, 'pint-master');

/***/ }),

/***/ "./_dev/guten-block/images-extend/fields.js":
/*!**************************************************!*\
  !*** ./_dev/guten-block/images-extend/fields.js ***!
  \**************************************************/
/*! no static exports found */
...
var registerFields = createHigherOrderComponent(function (BlockEdit) {
	return function (props) {
		...
		if (typeof pastIdProps[props.clientId] !== 'undefined' && !pastIdProps[props.clientId] && attributes.id) {
			...
			setAttributes({
				pinterestDesc: attachment.attributes.pm_pinterest_desc,
				pinterestRepinId: attachment.attributes.pm_pinterest_repin_id
			});
		}
				...
				wp.element.createElement(
					...
					wp.element.createElement(TextareaControl, {
						...
						onChange: function onChange(value) {
							return setAttributes({ pinterestDesc: value });
						},
					...
					wp.element.createElement(TextControl, {
						...
						onChange: function onChange(value) {
							return setAttributes({ pinterestRepinId: value });
						},
					...
					wp.element.createElement(CheckboxControl, {
						...
						onChange: function onChange(value) {
							return setAttributes({ pinterestNoPin: value });
						},
...
/***/ "./_dev/guten-block/images-extend/save.js":
/*!************************************************!*\
  !*** ./_dev/guten-block/images-extend/save.js ***!
  \************************************************/
/*! no static exports found */
...
var SavePint = function SavePint(element, blockType, attributes) {
	...
	imgProps.forEach(function (_ref) {
		...
		elementAsString = elementAsString.replace('<img ', '<img ' + attribute + '="' + value + '" ').replace(' class="wp-image-', ' class="' + className + ' wp-image-');
	});
...
/***/ "./_dev/guten-block/images-extend/settings.js":
/*!****************************************************!*\
  !*** ./_dev/guten-block/images-extend/settings.js ***!
  \****************************************************/
/*! no exports provided */
...
function getBlockSettings(settings, blockName) {
	...
	settings.attributes = babel_runtime_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()(settings.attributes, pintAttr);

	// raw <img> HTML transformation.
	...
	settings.transforms.from[2].attributes = babel_runtime_core_js_object_assign__WEBPACK_IMPORTED_MODULE_0___default()(settings.transforms.from[2].attributes, pintAttr);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _i18n_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./i18n.js */ "./_dev/guten-block/i18n.js");
...
/* harmony import */ var _images_extend_settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./images-extend/settings */ "./_dev/guten-block/images-extend/settings.js");
/* harmony import */ var _images_extend_fields__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./images-extend/fields */ "./_dev/guten-block/images-extend/fields.js");
/* harmony import */ var _images_extend_fields__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_images_extend_fields__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _images_extend_save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./images-extend/save */ "./_dev/guten-block/images-extend/save.js");
/* harmony import */ var _images_extend_save__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_images_extend_save__WEBPACK_IMPORTED_MODULE_3__);
...
/******/ });
//# sourceMappingURL=extend-editor.js.map