...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        evalCondition : function(context, control, condition, val1, val2) {
           ...
           *
           * Pin Master
           * Added new condition for Pin Master
           *
           * @since 1.0.0
           * @version 1.0.0
           *
...
+function ($) {
  ...
  CSTooltip.DEFAULTS = {
    ...
    placement: 'top',
    selector: false,
    template: '<div class="pm-tooltip" role="tooltip"><div class="pm-tooltip-arrow"></div><div class="pm-tooltip-inner"></div></div>',
    trigger: 'hover focus',
    title: '',
    delay: 0,
    html: false,
  ...
  CSTooltip.prototype.setContent = function () {
    ...
    $tip.find('.pm-tooltip-inner')[this.options.html ? 'html' : 'text'](title)
  ...
  CSTooltip.prototype.arrow = function () {
    return (this.$arrow = this.$arrow || this.tip().find('.pm-tooltip-arrow'))
  }
