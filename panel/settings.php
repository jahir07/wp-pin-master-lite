  ...
  'fields'      => array(
    ...
    array(
      ...
      'options'        => array(
        ...
        'img_description' => __( 'Image description', 'pin-master' ),
        'img_caption'     => __( 'Image caption', 'pin-master' ),
        'img_alt'         => __( 'Image alt attribute', 'pin-master' ),
      ...
      'default'  => ['post_title'],
      'desc'    => __( 'This is define from where the Pinterest message should be taken. Priority according to the chronological date. If One Option missed the data it will catch next one. Please note that "Image description" and "Image caption" work properly only for images that were added to your Media Library.', 'pin-master' ),
      'type'    => 'select',
      'class'         => 'chosen',
      'attributes'    => array(
